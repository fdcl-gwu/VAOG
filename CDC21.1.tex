...
% TODO: comment the following line for white background
%\usepackage{xcolor}\pagecolor{black}\color{white}
...
\begin{align*}
    H_d (R_k, P_{k+1}) 
    %& = \tr{R_k^T P_{k+1}}   - \frac{h}{2} \tr{ J^{-1} (\hat p_k^2 -\frac{1}{2} \tr{\hat p_k^2}  I) } \\
    %& = \tr{R_k^T P_{k+1}}   - \frac{h}{2} \tr{ J^{-1} \hat p_k^2} +  \frac{h}{4} \tr{\hat p_k^2}  \tr{J^{-1}}  \\
